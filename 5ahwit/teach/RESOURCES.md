...
- [R4DS 2e — Kap. 1 Data visualization](https://r4ds.hadley.nz/data-visualize)
  Hauptlektüre Lektion 01: ggplot-Grammatik, aes, Geoms, Facets. CC BY-NC-ND —
...
- [R4DS 2e — Kap. 3 Data transformation](https://r4ds.hadley.nz/transform)
  Hauptlektüre Lektion 02: filter/select/mutate/summarise, Pipe.
- [R4DS 2e — Kap. 7 Data import](https://r4ds.hadley.nz/data-import.html)
  Hauptlektüre Lektion 03: read_csv, Spaltentypen, Parsing-Probleme.
- [R4DS 2e — Kap. 10 Exploratory data analysis](https://r4ds.hadley.nz/EDA.html)
  Hauptlektüre Lektion 03: Kennzahlen, Variation, Kovariation.
- [palmerpenguins](https://allisonhorst.github.io/palmerpenguins/)
  Der Pinguin-Datensatz (Art/Insel/Maße). Daten für Lektion 01–0002.
...
- R/RStudio-Installation auf den Schul-Laptops der 5AHWIT ist nicht
  ...
  Klären, bevor Lektion 02 als HÜ läuft.
