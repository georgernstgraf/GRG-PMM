...
Unterricht vorkommt. UE-Verweise beziehen sich auf die Semesterpläne
(`4HWIT/semesterplan-ws.md`, `5HWIT/semesterplan-ws.md`).
...
|---|---|---|---|
| **KM** | Kompetenzmodul (Lehrplan-Einheit, KM3–KM9b) | Kaplan-Meier (Schätzer, Überlebenszeitanalyse) | Kaplan-Meier nur in KM9b/UE Zuverlässigkeit; sonst immer Kompetenzmodul |
...
|---|---|---|
| ASchG | ArbeitnehmerInnenschutzgesetz | Österr. Arbeitssicherheitsgesetz; UE 12 (5HWIT WS) |
...
| Begriff | Bedeutung | Kurzerklärung & Kontext |
|---|---|---|
| ANOVA | Analysis of Variance (Varianzanalyse) | Mittelwertvergleich von ≥3 Gruppen; UE 8 (4HWIT WS), Konzeptbrücke zu DoE |
| AQL | Acceptable Quality Limit | Schlechtester noch akzeptabler Qualitätszustand; Kerngröße ISO 2859, UE 9–10 |
...
| Bootstrap | Resampling mit Zurücklegen | Simulationsweg zu Konfidenzintervallen; ModernDive Kap. 8, UE 5 |
| CI | Confidence Interval (Konfidenzintervall) | ⚠ Kollision, s.o.; UE 5 |
| CLT | Central Limit Theorem (Zentraler Grenzwertsatz) | Stichprobenmittel → approx. normal für großes n; UE 5 |
...
| EDA | Exploratory Data Analysis | Explorative Datenanalyse; R4DS Kap. 10, UE 3 |
...
| H0 / H1 | Null- / Alternativhypothese | Grundgerüst jedes Tests; UE 6 |
...
| LTPD | Lot Tolerance Percent Defective | Schlechtes Qualitätsniveau, das fast immer zurückgewiesen werden soll; UE 9 |
| MSA | Measurement System Analysis (Messsystemanalyse) | Prüfmittelfähigkeit, Gage R&R; KM8, NIST Kap. 2 |
| MTBF / MTTF / MTTR | Mean Time Between Failures / To Failure / To Repair | Zuverlässigkeits- und Instandhaltungskennzahlen; KM9b, UE 12 (5HWIT) |
| OC-Kurve | Operating Characteristic | Annahmewahrscheinlichkeit in Abhängigkeit vom Qualitätsniveau; UE 9 |
| p-Wert | — | Wahrscheinlichkeit für Daten, die unter H0 mindestens so extrem sind — **nicht** die Wahrscheinlichkeit, dass H0 gilt!; UE 6 |
...
| Begriff | Bedeutung | Kurzerklärung & Kontext |
|---|---|---|
| 2^k | Vollfaktorieller Plan, k Faktoren à 2 Stufen | Alle Kombinationen; UE 2–4 (5HWIT WS) |
| 2^(k−p) | Teilfaktorieller Plan | Bruchteil der Kombinationen, Preis: Confounding; UE 5 |
| Alias / Confounding | Vermengung | Effekte nicht einzeln identifizierbar; Auflösung III/IV/V sagt, wie schlimm; UE 5 |
| BBD | Box-Behnken Design | RSM-Design ohne extreme Eckpunkte; UE 8 |
| Block | — | Homogene Teilmenge der Versuche; schirmt bekannte Störgröße ab; UE 6 |
| CCD | Central Composite Design | Standard-RSM-Design (Faktorial + Sternpunkte + Zentrum); UE 8 |
| Desirability | Zielufunktion | Mehrzieloptimierung über Wünschbarkeit 0–1; UE 10 |
| DoE | Design of Experiments (Versuchsplanung) | Gezieltes Erzeugen von Daten statt Analysieren vorhandener; KM9a-Kern |
| Faktor / Stufe | Factor / Level | Eingangsgröße und deren gewählte Ausprägung im Versuch; UE 1 |
| OFAT | One Factor At a Time | Naives Vorgehen (einen Faktor nach dem anderen) — versagt bei Wechselwirkungen; UE 1 |
| Randomisierung | Randomization | Zufällige Versuchsreihenfolge; schützt vor versteckten Störgrößen; UE 1 |
| Replikation | Replication | Echte Wiederholung eines Versuchspunkts (nicht: wiederholt messen!); UE 1 |
| RSM | Response Surface Methodology | Quadratische Modelle + Optimumsuche; UE 8–10 |
| S/N | Signal-to-Noise Ratio | Taguchi-Robustheitsmaß; UE 10 |
| Taguchi | Genichi Taguchi | Robust Design: Prozess unempfindlich gegen Rauschen machen; UE 10 |
| Zentrumspunkt | Center point | Versuch in der Faktorraum-Mitte; deckt Krümmung auf; UE 4 |
...
| DIN EN 15221 | Facility-Management-Normfamilie | Begriffe und Strukturen des FM; UE 12 (5HWIT WS) |
...
| ISO 2859 | Annahmeprüfung, attributiv | AQL-basierte Stichprobenpläne; UE 10 (4HWIT WS) |
| ISO 3951 | Annahmeprüfung, variabel | k-Methode auf Messwerten; UE 11 (4HWIT WS) |
...
| LCA | Life Cycle Assessment (Ökobilanz) | Lebenszyklus-Bilanz eines Produkts; UE 12 (4HWIT WS) |
...
| Sankey(-Diagramm) | — | Flussdiagramm mit mengenproportionalen Pfeilen; `networkD3`; UE 12 (4HWIT WS) |
| Stoffflussanalyse | Material Flow Analysis | Bilanzierung von Materialströmen; UE 12 (4HWIT WS) |
...
| d/p/q/r | density / probability / quantile / random | R-Funktionsfamilien für Verteilungen (`dnorm`, `pnorm`, `qnorm`, `rnorm`, …); UE 4 (4HWIT WS) |
...
| ggplot2 | — | Visualisierungspaket nach Grammar of Graphics; UE 1 (4HWIT WS) |
...
| Pipe | `%>%` bzw. `\|>` | Verkettet Operationen lesbar von links nach rechts; UE 2 (4HWIT WS) |
| R4DS | R for Data Science (Wickham, Çetinkaya-Rundel, Grolemund; 2e) | Hauptlektüre der Toolchain; r4ds.hadley.nz; UE 1–3 (4HWIT WS) |
| RStudio | — | IDE für R (Posit) |
| tibble | — | Moderner data frame im tidyverse |
| tidyverse | — | Paketsammlung (ggplot2, dplyr, readr, tidyr, …); UE 1–3 (4HWIT WS) |
| Whole Game | — | R4DS-Didaktik: erst das ganze Spiel erleben (Visualisierung!), dann Details; unser UE-1–3-Prinzip |
...
| Begriff | Bedeutung | Kurzerklärung & Kontext |
|---|---|---|
| Einstiegstest | — | Test zu Schuljahresbeginn (Repo GRG-PMM-T, 2026-09-07); prüft KM5/KM6-Vorwissen; reservierte DS R1 (4HWIT WS) |
